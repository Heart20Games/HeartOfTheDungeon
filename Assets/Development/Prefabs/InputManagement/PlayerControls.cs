...
//     version 1.4.4
//     from Assets/Development/Prefabs/InputManagement/PlayerControls.inputactions
//
    ...
    public struct GroundMovementActions
    {
        ...
        public void SetCallbacks(IGroundMovementActions instance)
        {
            if (m_Wrapper.m_GroundMovementActionsCallbackInterface != null)
            {
                ...
                @CastPrimary.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastPrimary;
                @CastPrimary.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastPrimary;
                @CastPrimary.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastPrimary;
                @CastSecondary.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastSecondary;
                @CastSecondary.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastSecondary;
                @CastSecondary.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnCastSecondary;
                @SwitchPrimary.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchPrimary;
                @SwitchPrimary.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchPrimary;
                @SwitchPrimary.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchPrimary;
                @SwitchSecondary.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchSecondary;
                @SwitchSecondary.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchSecondary;
                @SwitchSecondary.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchSecondary;
                ...
                @SwitchCharacterLeft.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterLeft;
                @SwitchCharacterLeft.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterLeft;
                @SwitchCharacterLeft.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterLeft;
                @SwitchCharacterRight.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterRight;
                @SwitchCharacterRight.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterRight;
                @SwitchCharacterRight.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterRight;
                @SwitchCharacterCenter.started -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterCenter;
                @SwitchCharacterCenter.performed -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterCenter;
                @SwitchCharacterCenter.canceled -= m_Wrapper.m_GroundMovementActionsCallbackInterface.OnSwitchCharacterCenter;
