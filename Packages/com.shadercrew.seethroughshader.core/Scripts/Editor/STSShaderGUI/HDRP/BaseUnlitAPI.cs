// SEE: https://github.com/Unity-Technologies/Graphics/blob/632f80e011f18ea537ee6e2f0be3ff4f4dea6a11/Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/BaseUnlitAPI.cs
...
namespace ShaderCrew.SeeThroughShader
{
    ...
    static class BaseUnlitAPI
    {
        public static void SetupBaseUnlitKeywords(this Material material)
        {
            ...
            MaterialUtils.SetKeyword(material, "_ALPHATEST_ON", alphaTestEnable);

            SurfaceType surfaceType = material.GetSurfaceType();
            MaterialUtils.SetKeyword(material, "_SURFACE_TYPE_TRANSPARENT", surfaceType == SurfaceType.Transparent);
            ...
            MaterialUtils.SetKeyword(material, "_TRANSPARENT_WRITES_MOTION_VEC", transparentWritesMotionVec);

            if (material.HasProperty(kAddPrecomputedVelocity))
                MaterialUtils.SetKeyword(material, "_ADD_PRECOMPUTED_VELOCITY", material.GetInt(kAddPrecomputedVelocity) != 0);
            ...
            MaterialUtils.SetKeyword(material, "_ENABLE_FOG_ON_TRANSPARENT", fogEnabled);
            ...
            MaterialUtils.SetKeyword(material, "_DOUBLESIDED_ON", doubleSidedEnable);
            ...
            if (!material.HasProperty(kDisplacementMode) && material.HasProperty(kDepthOffsetEnable))
            {
                ...
                if (material.HasProperty(kConservativeDepthOffsetEnable))
                {
                    ...
                    MaterialUtils.SetKeyword(material, "_CONSERVATIVE_DEPTH_OFFSET", conservativeDepthOffset);
                }
            }
            ...
            if (material.HasProperty(kTessellationMode))
            {
                ...
                MaterialUtils.SetKeyword(material, "_TESSELLATION_PHONG", tessMode == TessellationMode.Phong);
            }
