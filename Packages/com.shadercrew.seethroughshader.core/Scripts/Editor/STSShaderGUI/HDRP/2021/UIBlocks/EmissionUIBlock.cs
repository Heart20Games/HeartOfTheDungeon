...
namespace ShaderCrew.SeeThroughShader
{
    ...
    public class EmissionUIBlock : MaterialUIBlock
    {
        ...
        //SEE: https://github.com/Unity-Technologies/Graphics/blob/4b98cece5623e02f03c9ff311bca0f749ba4fd94/Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/Utility/HDUtils.cs
        ...
        {
            ConvertHDRColorToLDR(emissiveColor.colorValue, out var colorLDR, out var intensity);
            emissiveIntensity.floatValue = intensity;
            emissiveColorLDR.colorValue = colorLDR.gamma;
        }

        // SEE: https://github.com/Unity-Technologies/Graphics/blob/632f80e011f18ea537ee6e2f0be3ff4f4dea6a11/Packages/com.unity.render-pipelines.high-definition/Runtime/Lighting/LightUtils.cs
...

            {
                ...
                else
                {
                    if (!intensityIsMixed && unit == EmissiveIntensityUnit.EV100)
                    {
                        ...
                        float evValue = Mathf.Log(emissiveIntensity.floatValue, 2) + s_LuminanceToEvFactor;
                        ...
                        emissiveIntensity.floatValue = Mathf.Pow(2, evValue + s_EvToLuminanceFactor);
                    }
                    else
                    {
